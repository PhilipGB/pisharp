...
public sealed class ProviderCatalogTests : IDisposable
{
    ...
    public void BuiltinsCoverThePinnedProviderSet()
    {
        ...
        // llama.cpp is registered as a built-in here: pinned ships it as the bundled /llama
        // extension, PiSharp bundles both the provider and the command in the default surface.
        var expected = new[]
        {
            ...
            "llama.cpp", "minimax", "minimax-cn", "mistral", "moonshotai", "moonshotai-cn",
