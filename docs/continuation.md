...
- At this checkpoint format verification, warning-as-error build and 40/40 tests passed. `/model` manual same-endpoint switching has a conservative branch guard. Full parity remains outstanding.
