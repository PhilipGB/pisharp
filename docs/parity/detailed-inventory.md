...
- Shell/stats/export: `bash`, `abort_bash`, `get_session_stats` (in progress: approximate counts, no billed tokens/cost), `export_html` (in progress: private non-overwriting HTML, no Pi wire format) (parallel command/output/cancellation tests).
